...
Thanks for considering a contribution to winidjango! Following
...
opening a new issue, search [existing issues](https://github.com/Winipedia/winidjango/issues)
to avoid duplicates.
...
- All checks in [CI](https://github.com/Winipedia/winidjango/actions/workflows/health_check.yml) must pass before merge.
